-- Cargando datos de la tabla 'medico'.

INSERT INTO tp5.medico (matricula, nombre, apellido, especialidad, observaciones)
VALUES (155, 'Alfredo', 'Guiterrez', 'Medicina Familiar', 'No atiende PAMI'),
...
-- Cargando datos en la tabla 'ingreso'.

INSERT INTO tp5.ingreso (id_ingreso, fecha_ingreso, nro_habitacion, nro_cama, observaciones, nro_historial_paciente, matricula_medico)
VALUES
(1, '2021-11-01', 1, 2, NULL, 1884, 449),
(2, '2021-11-02', 1, 1, NULL, 1488, 226),
(3, '2021-11-02', 2, 4, 'Falta completar carnet de vacunación', 1498, 733),
...
(26, '2022-03-22', 6, 11, 'Cuenta con servicio integral de rehabilitación', 1498, 332),
...
(33, '2022-04-05', 6, 11, 'Internacion por deshidratación', 1488, 733),
