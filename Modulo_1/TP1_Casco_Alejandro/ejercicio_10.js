...
let meses = ['Enero','Febrero','Marzo','Abril','Mayo','Junio','Agosto','Septiembre','Noviembre','Diciembre']

const inputMes = window.prompt("Introduzca un número del 1 al 12");
...
if (inputMes >= 1 && inputMes <= 12) {
    ...
    document.write("El número ingresado no es válido. Por favor, ingresa un número del 1 al 12.");
  }